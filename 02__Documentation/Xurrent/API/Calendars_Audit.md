# Calendars - Audit Entries API

## List audit entries of a calendar

List all [audit entries](../../audit_entries.html) of a calendar with a specific ID.

```
GET /calendars/:id/audit
```
