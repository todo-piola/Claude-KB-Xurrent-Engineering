# Project Tasks - Audit Entries API

## List audit entries of a project task

List all [audit entries](../../audit_entries.html) of the project task with a specific ID.

```
GET /project_tasks/:id/audit
```
