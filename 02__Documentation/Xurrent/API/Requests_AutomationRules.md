# Requests - Automation Rules API

## List automation rules of a request

List all [automation rules](../../automation_rules.html) of the request with a specific ID.

```
GET /requests/:id/automation_rules
```
