# Out of Office Periods - Audit Entries API

## List audit entries of an out of office period

List all [audit entries](../../audit_entries.html) of an out of office period with a specific ID.

```
GET /out_of_office_periods/:id/audit
```
