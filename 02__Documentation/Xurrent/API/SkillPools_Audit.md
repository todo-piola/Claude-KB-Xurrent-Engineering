# Skill Pools - Audit Entries API

## List audit entries of a skill pool

List all [audit entries](../../audit_entries.html) of the skill pool with a specific ID.

```
GET /skill_pools/:id/audit
```
