...
List all [risks](../../risks.html) of a project with a specific ID
...
- `/projects/:id/risks/open`: List all open risks of a project with a specific ID
- `/projects/:id/risks/closed`: List all closed risks of a project with a specific ID
