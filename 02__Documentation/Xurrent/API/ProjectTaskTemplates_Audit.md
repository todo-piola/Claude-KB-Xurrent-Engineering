# Project Task Templates - Audit Entries API

## List audit entries of a project task template

List all [audit entries](../../audit_entries.html) of the project task template with a specific ID.

```
GET /project_task_templates/:id/audit
```
