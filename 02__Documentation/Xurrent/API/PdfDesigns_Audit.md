# PDF Designs - Audit Entries API

## List audit entries of a PDF Design

List all [audit entries](../../audit_entries.html) of a PDF Design with a specific ID.

```
GET /pdf_designs/:id/audit
```
