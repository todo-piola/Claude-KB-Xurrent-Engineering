# Scrum Workspaces - Audit Entries API

## List audit entries of a scrum workspace

List all [audit entries](../../audit_entries.html) of a scrum workspace with a specific ID.

```
GET /scrum_workspaces/:id/audit
```
