# Webhook policies - Audit Entries API

## List audit entries of a webhook policy

List all [audit entries](../../audit_entries.html) of the webhook policy with a specific ID.

```
GET /webhook_policies/:id/audit
```
