# Project Tasks - Notes API

- [List notes of a project task](index.html#list-notes-of-a-project-task)
- [Create a note](index.html#create-a-note)
- [Fields](index.html#fields)

## List notes of a project task

List all [notes](../../notes.html) of the project task with the given *:id*.

```
GET /project_tasks/:id/notes
```
