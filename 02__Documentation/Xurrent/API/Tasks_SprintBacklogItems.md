# Tasks - Sprint Backlog Items API

## List sprint backlog items of a task

List all [sprint backlog items](../../sprints/backlog_items/index.html) of the task with a specific ID.

```
GET /tasks/:id/sprint_backlog_items
```
