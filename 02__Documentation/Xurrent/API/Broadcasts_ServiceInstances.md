# Broadcasts - Service Instances API

## List all service instances of a broadcast

List all [service instances](../../service_instances/index.html) of a broadcast with a specific ID.

```
GET /broadcasts/:id/service_instances
```
...
- `/broadcasts/:id/service_instances/active`: List all active service instances of a broadcast with a specific ID
- `/broadcasts/:id/service_instances/inactive`: List all inactive service instances of a broadcast with a specific ID

## Add a service instance to a broadcast

Add a link between a broadcast with a specific ID and a service instance with a specific ID.

```
POST /broadcasts/:id/service_instances/:service_instance_id
```
...
## Remove a service instance from a broadcast

Remove the link between a broadcast with a specific ID and a service instance with a specific ID.

```
DELETE /broadcasts/:id/service_instances/:service_instance_id
```
