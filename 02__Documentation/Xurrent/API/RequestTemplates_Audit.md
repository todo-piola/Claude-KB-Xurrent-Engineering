# Request Template - Audit Entries API

## List audit entries of a request template

List all [Audit Entries](../../audit_entries.html) of the request template with with a specific ID.

```
GET /request_templates/:id/audit
```
