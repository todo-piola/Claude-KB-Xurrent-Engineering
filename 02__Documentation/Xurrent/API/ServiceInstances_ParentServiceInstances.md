# Service Instances - Parent Service Instances API

## List parent service instances of a service instance

List all [parent service instances](../index.html) of the service instance with a specific ID.

```
GET /service_instances/:id/parent_service_instances
```
