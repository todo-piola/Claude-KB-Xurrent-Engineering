# Broadcasts - Audit Entries API

## List audit entries of a broadcast

List all [audit entries](../../audit_entries.html) of a broadcast with a specific ID.

```
GET /broadcasts/:id/audit
```
