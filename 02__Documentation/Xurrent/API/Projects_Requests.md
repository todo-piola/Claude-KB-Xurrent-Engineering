...
List all [requests](../../requests.html) of a project with a specific ID.
...
- `/projects/:id/requests/completed`: List all completed requests of a project with a specific ID
- `/projects/:id/requests/open`: List all open requests of a project with a specific ID

## Add a request to a project

Add a link between a project with a specific ID and a request with a specific ID.

```
POST /projects/:id/requests/:request_id
```
...
Remove the link between a project with a specific ID and a request with a specific ID.

```
DELETE /projects/:id/requests/:request_id
```
...
Remove all links between a project with a specific ID and its requests.
