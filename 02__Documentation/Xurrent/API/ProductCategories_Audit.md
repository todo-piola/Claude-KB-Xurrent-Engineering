# Product Categories - Audit Entries API

## List audit entries of a product category

List all [audit entries](../../audit_entries.html) of a product category with a specific ID.

```
GET /product_categories/:id/audit
```
