# Services - Audit Entries API

## List audit entries of a service

List all [audit entries](../../audit_entries.html) of the service with a specific ID.

```
GET /services/:id/audit
```
