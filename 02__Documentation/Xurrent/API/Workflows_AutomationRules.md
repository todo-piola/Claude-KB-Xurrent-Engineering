# Workflows - Automation Rules API

## List automation rules of a workflow

List all [automation rules](../../automation_rules.html) linked to the workflow with a specific ID.

```
GET /workflows/:id/automation_rules
```
