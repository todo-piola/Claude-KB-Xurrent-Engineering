# Webhooks - Audit Entries API

## List Audit Entries of a Webhook

List all [audit entries](../../audit_entries.html) of a webhook with a specific ID.

```
GET /webhooks/:id/audit
```
