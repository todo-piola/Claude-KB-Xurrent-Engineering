# Task Templates - Audit Entries API

## List audit entries of a task template

List all [audit entries](../../audit_entries.html) of the task template with a specific ID.

```
GET /task_templates/:id/audit
```
