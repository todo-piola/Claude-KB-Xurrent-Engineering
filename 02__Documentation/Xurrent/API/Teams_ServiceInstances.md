# Teams - Service Instances API

## List all service instances of a team

List all [service instances](../../service_instances/index.html) of a team with a specific ID.

```
GET /teams/:id/service_instances
```
...
- `/teams/:id/service_instances/active`: List all active service instances of a team with a specific ID
- `/teams/:id/service_instances/inactive`: List all inactive service instances of a team with a specific ID
