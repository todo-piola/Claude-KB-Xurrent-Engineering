# SLA Notification Schemes - Audit Entries API

## List audit entries of an SLA notification scheme

List all [audit entries](../../audit_entries.html) of an SLA notification scheme with a specific ID.

```
GET /sla_notification_schemes/:id/audit
```
