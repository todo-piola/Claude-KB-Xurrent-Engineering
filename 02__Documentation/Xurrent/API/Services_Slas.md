# Services - Service Level Agreements API

## List service level agreements of a service

List all [service level agreements](../../service_level_agreements.html) of the service with a specific ID.

```
GET /services/:id/slas
```
...
- `/services/:id/slas/active`: List all active service level agreements of a service with a specific ID
- `/services/:id/slas/inactive`: List all inactive service level agreements of a service with a specific ID
