...
## List automation rules of a workflow template

List all [automation rules](../../automation_rules.html) linked to the workflow template with a specific ID.

```
GET /workflow_templates/:id/automation_rules
```

Note: use the [Workflow Templates - Task Template Automation Rules API](../task_template_automation_rules.html) to get automation rules linked to task templates of a workflow template.
