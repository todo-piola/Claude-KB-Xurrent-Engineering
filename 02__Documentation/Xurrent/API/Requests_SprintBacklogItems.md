# Requests - Sprint Backlog Items API

## List sprint backlog items of a request

List all [sprint backlog items](../../sprints/backlog_items/index.html) of the request with a specific ID.

```
GET /requests/:id/sprint_backlog_items
```
