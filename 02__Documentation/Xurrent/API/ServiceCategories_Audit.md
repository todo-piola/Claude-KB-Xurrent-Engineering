# Service Categories - Audit Entries API

## List audit entries of a service category

List all [audit entries](../../audit_entries.html) of a service category with a specific ID.

```
GET /service_categories/:id/audit
```
