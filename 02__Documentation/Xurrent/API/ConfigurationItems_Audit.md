# Configuration Items - Audit Entries API

## List audit entries of a configuration item

List all [audit entries](../../audit_entries.html) of the configuration item with a specific ID.
