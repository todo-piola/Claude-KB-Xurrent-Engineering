# Workflow Types - Audit Entries API

## List audit entries of a workflow type

List all [audit entries](../../audit_entries.html) of a workflow type with a specific ID.

```
GET /workflow_types/:id/audit
```
