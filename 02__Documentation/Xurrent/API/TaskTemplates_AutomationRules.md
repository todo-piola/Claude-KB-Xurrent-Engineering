# Task Templates - Automation Rules API

## List automation rules of a task template

List all [automation rules](../../automation_rules.html) of the task template with a specific ID.

```
GET /task_templates/:id/automation_rules
```
