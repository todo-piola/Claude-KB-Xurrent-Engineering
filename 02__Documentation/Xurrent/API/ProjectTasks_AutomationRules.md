# Project Tasks - Automation Rules API

## List automation rules of a project task

List all [automation rules](../../automation_rules.html) of the project task with a specific ID.
