# Closure Codes - Audit Entries API

## List audit entries of a closure code

List all [audit entries](../../audit_entries.html) of a closure code with a specific ID.

```
GET /closure_codes/:id/audit
```
