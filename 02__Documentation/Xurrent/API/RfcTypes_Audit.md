# RFC Types - Audit Entries API

## List audit entries of a RFC type

List all [audit entries](../../audit_entries.html) of a RFC type with a specific ID.

```
GET /rfc_types/:id/audit
```
