# Project Risk Levels - Audit Entries API

## List audit entries of a project risk level

List all [audit entries](../../audit_entries.html) of a project risk level with a specific ID.

```
GET /project_risk_levels/:id/audit
```
