# Service Instances - Audit Entries API

## List audit entries of a service instance

List all [audit entries](../../audit_entries.html) of the service instance with a specific ID.

```
GET /service_instances/:id/audit
```
