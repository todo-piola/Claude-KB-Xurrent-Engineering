# Time Allocations - Audit Entries API

## List audit entries of a time allocation

List all [audit entries](../../audit_entries.html) of a time allocation with a specific ID.

```
GET /time_allocations/:id/audit
```
