# Service Offerings - Audit Entries API

## List audit entries of a service offering

List all [audit entries](../../audit_entries.html) of the service offering with a specific ID.

```
GET /service_offerings/:id/audit
```
