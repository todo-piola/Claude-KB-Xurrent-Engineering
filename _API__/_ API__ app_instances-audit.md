# App Instances - Audit Entries API

## List audit entries of an app instance

List all [audit entries](../../audit_entries.html) of the app instance with a specific ID.

```
GET /app_instances/:id/audit
```
