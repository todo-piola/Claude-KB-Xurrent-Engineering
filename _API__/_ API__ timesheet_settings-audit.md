# Timesheet Settings - Audit Entries API

## List audit entries of a timesheet settings

List all [audit entries](../../audit_entries.html) of a timesheet settings with a specific ID.

```
GET /timesheet_settings/:id/audit
```
