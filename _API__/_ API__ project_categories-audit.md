# Project Categories - Audit Entries API

## List audit entries of a project category

List all [audit entries](../../audit_entries.html) of a project category with a specific ID.

```
GET /project_categories/:id/audit
```
