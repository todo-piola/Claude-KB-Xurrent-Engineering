# App Offerings - Audit Entries API

## List audit entries of an app offering

List all [audit entries](../../audit_entries.html) of the app offering with a specific ID.

```
GET /app_offerings/:id/audit
```
