# Project Task Templates - Automation Rules API

## List automation rules of a project task template

List all [automation rules](../../automation_rules.html) of the project task template with a specific ID.

```
GET /project_task_templates/:id/automation_rules
```
