# Shop Order Lines - Audit Entries API

## List audit entries of a shop order line

List all [audit entries](../../audit_entries.html) of a shop order line with a specific ID.

```
GET /shop_order_lines/:id/audit
```
