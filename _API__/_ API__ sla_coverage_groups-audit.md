# SLA Coverage Groups - Audit Entries API

## List audit entries of a SLA coverage group

List all [audit entries](../../audit_entries.html) of a SLA coverage group with a specific ID.

```
GET /sla_coverage_groups/:id/audit
```
