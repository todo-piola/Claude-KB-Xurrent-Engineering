# Request Templates - Automation Rules API

## List automation rules of a request template

List all [automation rules](../../automation_rules.html) of the request template with a specific ID.

```
GET /request_templates/:id/automation_rules
```
