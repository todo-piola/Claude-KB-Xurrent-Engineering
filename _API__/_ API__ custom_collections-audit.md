# Custom Collections - Audit Entries API

## List audit entries of a custom collection

List all [audit entries](../../audit_entries.html) of a custom collection with a specific ID.

```
GET /custom_collections/:id/audit
```
