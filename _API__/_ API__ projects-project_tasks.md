# Projects - Project Tasks API

## List all project tasks of a project

List all [project tasks](../../project_tasks.html) of a project with a specific ID.
...
- `/projects/:id/tasks/finished`: List all finished project tasks of a project with a specific ID
- `/projects/:id/tasks/open`: List all open project tasks of a project with a specific ID
