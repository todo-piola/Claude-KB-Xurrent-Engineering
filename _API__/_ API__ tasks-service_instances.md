...
List all [service instances](../../service_instances/index.html) of a task with a specific ID.
...
- `/tasks/:id/service_instances/active`: List all active service instances of a task with a specific ID
- `/tasks/:id/service_instances/inactive`: List all inactive service instances of a task with a specific ID
