# Project Templates - Audit Entries API

## List audit entries of a project template

List all [audit entries](../../audit_entries.html) of the project template with a specific ID.

```
GET /project_templates/:id/audit
```
