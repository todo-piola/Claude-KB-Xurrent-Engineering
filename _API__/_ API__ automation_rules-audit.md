# Automation Rules - Audit Entries API

## List audit entries of an automation rule

List all [audit entries](../../audit_entries.html) of the automation rule with a specific ID.

```
GET /automation_rules/:id/audit
```
