# Waiting for Customer Follow-Ups - Audit Entries API

## List audit entries of a waiting for customer follow-up

List all [audit entries](../../audit_entries.html) of a waiting for customer follow-ups with a specific ID.

```
GET /waiting_for_customer_follow_ups/:id/audit
```
