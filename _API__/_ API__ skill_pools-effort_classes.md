...
List all [effort classes](../../effort_classes.html) of a skill pool with a specific ID.
...
- `/skill_pools/:id/effort_classes/disabled`: List all disabled effort classes of a skill pool with a specific ID
- `/skill_pools/:id/effort_classes/enabled`: List all enabled effort classes of a skill pool with a specific ID
