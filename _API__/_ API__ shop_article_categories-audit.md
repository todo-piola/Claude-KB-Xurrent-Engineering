# Shop Article Categories - Audit Entries API

## List audit entries of a shop article category

List all [audit entries](../../audit_entries.html) of a shop article category with a specific ID.

```
GET /shop_article_categories/:id/audit
```
