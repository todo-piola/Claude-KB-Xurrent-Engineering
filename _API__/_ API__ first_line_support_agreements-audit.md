# First Line Support Agreements - Audit Entries API

## List audit entries of a first line support agreement

List all [audit entries](../../audit_entries.html) of the first line support agreement with a specific ID.
