# Knowledge Article Templates - Audit Entries API

## List audit entries of a knowledge article template

List all [audit entries](../../audit_entries.html) of a knowledge article template with a specific ID.

```
GET /knowledge_article_templates/:id/audit
```
