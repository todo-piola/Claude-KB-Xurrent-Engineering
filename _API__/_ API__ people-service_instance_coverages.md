# People - Service Instance Coverages API

## List service instance coverages of a person

List all [service instances](../../service_instances/index.html) for which a person with a specific ID is covered by an [SLA](../../service_level_agreements.html).

```
GET /people/:id/service_instance_coverages
```
...
[Filtering](../../general/filtering.html) is available for the following [fields](../../service_instances/index.html#fields):
