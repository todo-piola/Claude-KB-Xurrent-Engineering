# Risk Severities - Audit Entries API

## List audit entries of a risk severity

List all [audit entries](../../audit_entries.html) of a risk severity with a specific ID.

```
GET /risk_severities/:id/audit
```
