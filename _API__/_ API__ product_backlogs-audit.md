# Product Backlogs - Audit Entries API

## List audit entries of an product backlog

List all [audit entries](../../audit_entries.html) of the product backlog with a specific ID.

```
GET /product_backlogs/:id/audit
```
