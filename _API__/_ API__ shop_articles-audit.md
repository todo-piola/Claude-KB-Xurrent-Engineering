# Shop Articles - Audit Entries API

## List audit entries of a shop article

List all [audit entries](../../audit_entries.html) of a shop article with a specific ID.

```
GET /shop_articles/:id/audit
```
