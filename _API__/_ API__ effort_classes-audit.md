# Effort Classes - Audit Entries API

## List audit entries of an effort class

List all [audit entries](../../audit_entries.html) of an effort class with a specific ID.

```
GET /effort_classes/:id/audit
```
