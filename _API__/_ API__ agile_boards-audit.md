# Agile Boards - Audit Entries API

## List audit entries of an agile board

List all [audit entries](../../audit_entries.html) of the agile board with a specific ID.

```
GET /agile_boards/:id/audit
```
