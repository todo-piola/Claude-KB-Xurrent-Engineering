# Holidays - Audit Entries API

## List audit entries of a holiday

List all [audit entries](../../audit_entries.html) of a holiday with a specific ID.

```
GET /holidays/:id/audit
```
