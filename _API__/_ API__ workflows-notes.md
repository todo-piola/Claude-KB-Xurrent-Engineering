...
- [List notes of a workflow](index.html#list-notes-of-a-workflow)
- [Create a note](index.html#create-a-note)
- [Fields](index.html#fields)

## List notes of a workflow

List all [notes](../../notes.html) of the workflow with a specific ID.

```
GET /workflows/:id/notes
```
