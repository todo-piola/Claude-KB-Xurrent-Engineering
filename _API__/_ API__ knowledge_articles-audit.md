# Knowledge Articles - Audit Entries API

## List audit entries of a knowledge article

List all [audit entries](../../audit_entries.html) of a knowledge article with a specific ID.

```
GET /knowledge_articles/:id/audit
```
